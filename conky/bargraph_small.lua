...
function conky_main_bars()
	local bars_settings={
		...
		{	--[ Graph for Root ]--
			...
			alarm_colour={0xFF0000,0.72},
			bg_colour={0xFFFFFF,0.25},
			fg_colour={0x00C6FF,0.55},
			mid_colour={{0.45,0x00C6FF,0.90}},
			x=800,y=882,
			blocks=70,
			space=0,
			height=2,width=6,
		...
		{	--[ Graph for Home ]--
			...
			max=100,
			alarm=40,
			alarm_colour={0x00FF00,1.72},
			bg_colour={0xFFFFFF,0.25},
			fg_colour={0xFF0000,1.55},
			mid_colour={{0.45,0xFFFF00,1.70}},
			x=550,y=882,
			blocks=40,
			space=2,
			height=2,width=2,
...
function conky_draw_bg()
    imagen = Image.load("~/Descargas/art.png")
end
