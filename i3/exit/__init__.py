...
class OpenboxLogout():
    ...
    def load_config(self, config):
        ...
        if self.parser.has_section("looks"):
            ...
            if self.parser.has_option("looks", "buttons"):
        ...
        self.theme_prefix = os.path.split(os.path.realpath(__file__))[0] + '/themes'

        self.img_path = "%s/%s" % (self.theme_prefix, self.button_theme)
        ...
        # buttonname = [_('cancelar'), _('logout'), _('restart'), _('shutdown'), _('suspend'), _('hibernate'), _('safesuspend'), _('lock'), _('switch')]
