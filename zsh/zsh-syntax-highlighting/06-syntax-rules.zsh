...
ZSH_HIGHLIGHT_STYLES[alias]='fg=magenta,normal'
ZSH_HIGHLIGHT_STYLES[function]='fg=magenta,normal'

# Commands and builtins
ZSH_HIGHLIGHT_STYLES[command]="fg=green,normal"
ZSH_HIGHLIGHT_STYLES[hashed-command]="fg=green,normal"
ZSH_HIGHLIGHT_STYLES[builtin]="fg=green,normal"
